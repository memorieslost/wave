--[[
    VIOLENT NOTIFIER V4.1 - FIXED SERVER HOP (MINIMAL)
...
-- Configuração da Janela (Ultra Compacta)
local win = Library:Window({ 
    name = "VIOLENT",
    size = Vector2.new(240, 140)
})
...
local section = main:Section({ name = "STATUS", side = "left" })

section:Label({ name = "DETECÇÃO: ATIVA" })
section:Label({ name = "HOP AUTOMÁTICO (5M)" })
section:Label({ name = "TECLA [DEL] OCULTA UI" })
...
Library:AddNotification("VIOLENT", "Sistema Minimalista Carregado!", 3)
